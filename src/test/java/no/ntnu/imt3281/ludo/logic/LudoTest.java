...
public class LudoTest {
	 ...
	 * to four players. Trying to add a fifth player should throw an exception.
	 ...
	 * players should be placed at position 0 (start field). Player RED will always
	 * start, so playersTurn should return RED.
	 */
	@Test
	public void testInitialPositions() {
		...
		// It should be player RED's turn. This player can throw the dice and try to
		// move
		// his/her pieces.
	 ...
	 * placed at the home position at the beginning of the game it means that the
	 ...
	 * When all players pieces is finished (at position 59) the game is completed
	 * and correct winner is set. Also checks game status, "Created", "Initiated",
	 * "Started", "Finished".
	 */
	@Test
	...
	public void checkPlayerLocationToBoardLocationConversion() {
		...
		// Last field that the piece can interfere with other players (53) should be 16,
		// 29, 42 and 55
		...
		// First field of the "home stretch" (player position 54) should be 68, 74, 80
		// and 86
	 ...
	 * throws the dice and can not move or a player has moved and should not throw
	 * again a new player becomes the active player. Check that the correct messages
	 * are thrown.
	 */
	@Test
